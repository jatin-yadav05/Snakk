...
const Login = () => {
    ...
    return (
        <div className="w-full h-screen flex flex-col justify-around items-center overflow-hidden relative px-10 pb-60">
            <div className='absolute -z-10 bottom-0 opacity-50 bg-[url("/Login-bottom.svg")] w-full h-full bg-no-repeat bg-bottom'></div>
            ...
            <div className="w-full h-1/2 flex flex-col items-center justify-center gap-4">
                <div className="flex flex-col items-center justify-center gap-8 w-full">
                    <div className="input-fields flex flex-col w-full gap-5">
                        ...
                        <div className="flex flex-col items-end gap-2">
                            ...
                            <a className="forgot-pass font-semibold text-xs text-orange-600">Forgot Password?</a>
                        </div>
                    </div>
                ...
                <div className="text-sm text-gray-600">
                    ...
                    <a className="text-orange-600 font-semibold" href="/signup"> Sign Up</a>
                </div>
            </div>
        </div>
    );
